...
if WITH_HTTPD_PACKAGE:
    ...
    BINDIR = '/var/www/html/ppa/ppaenv/lib/python3.5/site-packages/mod_wsgi_packages/httpd/bin'
    SBINDIR = '/var/www/html/ppa/ppaenv/lib/python3.5/site-packages/mod_wsgi_packages/httpd/bin'
    LIBEXECDIR = '/var/www/html/ppa/ppaenv/lib/python3.5/site-packages/mod_wsgi_packages/httpd/modules'
    SHLIBPATH = ''
